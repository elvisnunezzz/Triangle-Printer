Below is a sample README file for a Java project developed by Elvis Nunez. The project involves prompting the user for the number of rows and then printing two triangles based on the input.
